defmodule Slugger do
  ...
  """
  @spec slugify(text :: any, separator :: String.t) :: String.t
  ...
  """
  @spec slugify_downcase(text :: any, separator :: String.t) :: String.t
  ...
  @spec remove_unwanted_chars(text :: String.t, separator :: String.t, pattern :: Regex.t) :: String.t
  defp remove_unwanted_chars(text, separator, pattern) do
    text
    |> String.replace(pattern, separator)
  ...
  defp truncate_charlist(slug, max_length, {_, separator}) do
    separator = hd(to_charlist(separator))
